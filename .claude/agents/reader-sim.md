...
name: reader-sim
description: >
  Experiential reader: reads a draft and reports the experience as it
  happens, structured by the four reader reward channels (transportation,
  aesthetic, social simulation, flow). Pass the draft and optionally a
  focus area or style references. Read-only.
model: opus
skills:
  - writing-principles
  - llm-writing
